...
export default {
    ...
    Mutation: {
        addUser: async (root, {firstname, lastname, email, password, userType}) => {
        ...
        editUser: async (root, {_id, firstname, lastname, password}, {user}) => {
            ...
            const response = await User.findByIdAndUpdate({_id}, {$set: {firstname, lastname, password}}, {new: true}).exec();
            if(!response){
            ...
            return response;
            // return new Promise((resolve, reject) => {
            //     User.findByIdAndUpdate({_id}, {$set: {firstname, lastname, email, password}}, {new: true})
            //         .exec((error, response) => {
            //         error ? reject(error) : resolve(response);
            //     })
            // })
